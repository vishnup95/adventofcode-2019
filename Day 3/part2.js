      ...
      case "L":
        for (let i = 0; i < Number(steps); i++) {
          points.push([
            points[points.length - 1][0] - 1,
            points[points.length - 1][1],
            points[points.length - 1][2] + 1 // three values ...
          ]);
        }
        break;
      ...
      case "U":
        for (let i = 0; i < Number(steps); i++) {
          points.push([
            ...
            points[points.length - 1][2] + 1 // two values ...
          ]);
        }
        break;
